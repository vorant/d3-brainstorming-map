...
import {BrainstormingMapParams} from "./brainstorming-map-params";
import {BrainstormingMapHelper} from "./brainstorming-map-helper";
import {BrainstormingMapShapes} from "./brainstorming-map-shapes";
...
export class BrainstormingMap {
  ...
  private params: BrainstormingMapParams;
  private helper: BrainstormingMapHelper;
  private shapesHelper: BrainstormingMapShapes;
  private eventObservable: Observable<string>;
  ...
  private update(position) {
    ...
    function dragged(d) {
      ...
      if (this.eventObservable) {
        this.eventObservable.next(currentShape)
      }
  ...
  init(id, width, height, data, params = {}) {
    ...
    this.params = new BrainstormingMapParams(params);
    this.helper = new BrainstormingMapHelper(this, this.params);
    this.shapesHelper = new BrainstormingMapShapes(this, this.params);
