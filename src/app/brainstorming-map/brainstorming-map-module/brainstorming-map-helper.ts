...
import {BrainstormingMap} from "./brainstorming-map";

export class BrainstormingMapHelper {

  constructor(private map: BrainstormingMap, private params: BrainstormingMapParams) {
  }
